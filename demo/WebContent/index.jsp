                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="${pageContext.request.contextPath}/resources/images/static/avatar3.png" class="img-circle" alt="User Image"/>
                                                </div>
                                                <h4>
                                                    Support Team
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="${pageContext.request.contextPath}/resources/images/static/avatar2.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-table"></i> <span>Customer module</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                            	<li><a href="pages/tables/data.html"><i class="fa fa-angle-double-right"></i> Add Customer</a></li>
                                <li><a href="pages/tables/simple.html"><i class="fa fa-angle-double-right"></i>All Customers</a></li>
                                <li><a href="pages/tables/data.html"><i class="fa fa-angle-double-right"></i> Active customers</a></li>
                                <li><a href="pages/tables/data.html"><i class="fa fa-angle-double-right"></i> In-active customers</a></li>
                            </ul>
                        </li>
                        <li>
